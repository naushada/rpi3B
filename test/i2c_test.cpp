...
TEST_F(I2CTest, Enable_Disable) {
    ...
    i2c().disable();
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::I2CEN), 0U);
}

TEST_F(I2CTest, Control_Field_SetClrGet) {
    i2c().set_control(BCM2837::BSCRegistersAddress::Control::INTR, 1);
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::INTR), 1U);
    i2c().clr_control(BCM2837::BSCRegistersAddress::Control::INTR);
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::INTR), 0U);
}

TEST_F(I2CTest, Control_Multibit_CLEAR_Field) {
    /* CLEAR is a 2-bit field at bits[5:4]. */
    i2c().set_control(BCM2837::BSCRegistersAddress::Control::CLEAR, 0b10);
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::CLEAR), 0b10U);
}

TEST_F(I2CTest, Control_Fields_Are_Independent) {
    /* Setting one field must not disturb another (read/modify/write). */
    i2c().set_control(BCM2837::BSCRegistersAddress::Control::I2CEN, 1);
    i2c().set_control(BCM2837::BSCRegistersAddress::Control::READ, 1);
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::I2CEN), 1U);
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::READ), 1U);
    i2c().clr_control(BCM2837::BSCRegistersAddress::Control::READ);
    EXPECT_EQ(i2c().get_control(BCM2837::BSCRegistersAddress::Control::I2CEN), 1U);
...
TEST_F(I2CTest, Status_Read) {
    ...
    EXPECT_EQ(i2c().get_status(BCM2837::BSCRegistersAddress::Status::DONE), 0U);
    EXPECT_EQ(i2c().get_status(BCM2837::BSCRegistersAddress::Status::TA), 0U);
}
